...
# $1 and $2 is our positional arguments and the values for those arguments will be passed while executing the bash file.
# run the file like this -> bash file_name.sh Counter Strike 
